...
class TestSquare_instantiation(unittest.TestCase):
    """Tests for the instantiation of the Square class."""
...
class TestSquare_size(unittest.TestCase):
    """Tests for the initialization of the size attribute in Square."""
...
class TestSquare_x(unittest.TestCase):
    """Tests for the initialization of the x attribute in Square."""
